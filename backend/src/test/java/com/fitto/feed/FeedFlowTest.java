...
class FeedFlowTest {
    ...
    void 타임라인은_포스트와_운동_식단을_한_피드로_병합한다() {
        ...
        mealService.save(c[0], new SaveMealRequest(LocalDate.now(), MealType.DINNER, "회식", null, 800, null, null, null, null));
    ...
    void 항목이_없는_식단_카드는_메모로_보여준다() {
        ...
        mealService.save(c[0], new SaveMealRequest(
                LocalDate.now(), MealType.LUNCH, "회식", null, 800, null, null, null, null));
