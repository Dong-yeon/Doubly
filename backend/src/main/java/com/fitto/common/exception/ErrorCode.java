...
public enum ErrorCode {
    ...
    // 통화 스파이크 (claude/call-spike-android) — PLAN.md "통화·영상통화" 참고
    STREAM_NOT_CONFIGURED(HttpStatus.SERVICE_UNAVAILABLE, "통화 스파이크가 아직 설정되지 않았어요. STREAM_API_KEY/STREAM_API_SECRET 을 확인해주세요.");
