...
public enum AnimatedSticker {
    ...
    ANIM_HEART("하트", StickerPacks.ANIM_ALL),
    ANIM_SPARKLING_HEART("반짝하트", StickerPacks.ANIM_ALL),
    ANIM_HEART_EYES("반함", StickerPacks.ANIM_ALL),
    ANIM_STAR_STRUCK("감탄", StickerPacks.ANIM_ALL),
    ANIM_HUG("안아줘", StickerPacks.ANIM_ALL),
    ANIM_FINGER_HEART("핑거하트", StickerPacks.ANIM_ALL),
    ANIM_HAND_HEART("손하트", StickerPacks.ANIM_ALL),
    ANIM_CUPID("큐피드", StickerPacks.ANIM_ALL),
    ANIM_GIFT_HEART("리본하트", StickerPacks.ANIM_ALL),
    ANIM_GROWING_HEART("점점더", StickerPacks.ANIM_ALL),
    ANIM_BEATING_HEART("콩닥콩닥", StickerPacks.ANIM_ALL),
    ANIM_REVOLVING_HEARTS("빙글빙글", StickerPacks.ANIM_ALL),
    ...
    ANIM_SMILE("흐뭇", StickerPacks.ANIM_ALL),
    ANIM_YAWN("졸려", StickerPacks.ANIM_ALL),
    ANIM_SLEEPING("잘게", StickerPacks.ANIM_ALL),
    ANIM_OOPS("앗", StickerPacks.ANIM_ALL),
    ANIM_FLUSHED("얼굴빨개짐", StickerPacks.ANIM_ALL),
    ANIM_RELIEVED("후련", StickerPacks.ANIM_ALL),
    ANIM_DROOL("군침", StickerPacks.ANIM_ALL),
    ANIM_WOOZY("알딸딸", StickerPacks.ANIM_ALL),
    ANIM_SMIRK("씨익", StickerPacks.ANIM_ALL),
    ANIM_UPSIDE_DOWN("어쩔", StickerPacks.ANIM_ALL),
    ANIM_HALO("천사", StickerPacks.ANIM_ALL),
    ANIM_THINKING("흠", StickerPacks.ANIM_ALL),
    ...
    ANIM_HUFF("씩씩", StickerPacks.ANIM_ALL),
    ANIM_CRY("눈물", StickerPacks.ANIM_ALL),
    ANIM_DISAPPOINTED("실망", StickerPacks.ANIM_ALL),
    ANIM_PENSIVE("시무룩", StickerPacks.ANIM_ALL),
    ANIM_WEARY("힘들어", StickerPacks.ANIM_ALL),
    ANIM_TIRED("지쳤어", StickerPacks.ANIM_ALL),
    ANIM_ANGRY("화났어", StickerPacks.ANIM_ALL),
    ANIM_CURSING("폭발", StickerPacks.ANIM_ALL),
    ANIM_UNAMUSED("별로", StickerPacks.ANIM_ALL),
    ANIM_EYE_ROLL("하아", StickerPacks.ANIM_ALL),
    ...
    ANIM_GIFT("선물", StickerPacks.ANIM_ALL),
    ANIM_ROSE("장미", StickerPacks.ANIM_ALL),
    ANIM_BOUQUET("꽃다발", StickerPacks.ANIM_ALL),
    ANIM_CONFETTI("꽃가루", StickerPacks.ANIM_ALL),
    ANIM_BALLOON("풍선", StickerPacks.ANIM_ALL),
    ANIM_SPARKLES("반짝", StickerPacks.ANIM_ALL),
    ANIM_CHEERS("짠", StickerPacks.ANIM_ALL),
    ANIM_CHAMPAGNE("축포", StickerPacks.ANIM_ALL),
    ...
    ANIM_MUSCLE("힘내", StickerPacks.ANIM_ALL),
    ANIM_PRAY("부탁해", StickerPacks.ANIM_ALL),
    ANIM_EYES("봐봐", StickerPacks.ANIM_ALL),
    ANIM_CLAP("짝짝짝", StickerPacks.ANIM_ALL),
    ANIM_RAISED_HANDS("만세", StickerPacks.ANIM_ALL),
    ANIM_FIST("화이팅", StickerPacks.ANIM_ALL),
    ANIM_HUNDRED("백점", StickerPacks.ANIM_ALL),
    ANIM_STAR("별", StickerPacks.ANIM_ALL),
    ANIM_GLOWING_STAR("반짝별", StickerPacks.ANIM_ALL),
    ANIM_POINTING("너!", StickerPacks.ANIM_ALL),
    ANIM_HANDSHAKE("콜", StickerPacks.ANIM_ALL),
    ANIM_TARGET("명중", StickerPacks.ANIM_ALL),
    ...
    ANIM_FOX("여우", StickerPacks.ANIM_ALL),
    ANIM_LION("사자", StickerPacks.ANIM_ALL),
    ANIM_FROG("개구리", StickerPacks.ANIM_ALL),
    ...
    ANIM_BURGER("버거", StickerPacks.ANIM_ALL),
    ANIM_ICE_CREAM("아이스크림", StickerPacks.ANIM_ALL),
    ANIM_STRAWBERRY("딸기", StickerPacks.ANIM_ALL),
    ANIM_WATERMELON("수박", StickerPacks.ANIM_ALL),
