...
import { STATUS_FILTERS, DIET_FILTERS, CATEGORY_FILTERS } from './placeFilters';
...
export function PlaceScreen() {
  ...
  // 위시리스트/지도가 공유하는 검색·상태·식단 필터 — 가이드엔 없다(등급순 정렬 하나뿐).
  ...
  const wishlistPlaces = useMemo(
    ...
    [allPlaces, search, statusFilter, dietFilter, categoryFilter],
  );
