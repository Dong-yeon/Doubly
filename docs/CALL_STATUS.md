...
> **2026-09-26 최신 현황·남은 것은 [CALL_AND_DOCKER_REVIEW_2026-09-26.md](CALL_AND_DOCKER_REVIEW_2026-09-26.md)** —
> 9/23 권한 수정 두 건, Stream 토큰 60분 만료 문제, 24시간 스위퍼의 통화시간 오기록, 안드로이드 종료 상태 벨 경로.
