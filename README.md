...
| 커플 게임 | 협동 스도쿠 — 둘이 같은 판을 차례 없이 채움(V86 `couple_games`, 행 잠금으로 동시 입력 보호, 틀린 칸 표시, 완성 시 `GAME_CARD` 채팅 카드 + 푸시, 홈 퀵액션 `스도쿠`). 방향 결정·다음 후보(서로 맞히기·사진 직소·오목·boo 오늘의 판)는 `docs/COUPLE_GAMES_DESIGN_2026-09-09.md` | ✅ 완료(2026-09-09) — 실기기 검증 전 |
