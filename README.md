...
DB 스키마는 `backend/src/main/resources/db/migration/` 의 Flyway 마이그레이션(V1~V20)에 정의되어
...
feed_posts / feed_reactions / trips / trip_items(일자별 일정표) / trip_expenses(경비 정산) /
trip_checklist_items(준비물 체크리스트).
